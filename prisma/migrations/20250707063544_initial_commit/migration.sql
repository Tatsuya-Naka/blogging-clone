...
CREATE TABLE "User" (
    ...
    "image" TEXT,
    "bio" TEXT NOT NULL DEFAULT '404 bio',
    "password" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "CommentLike" ADD CONSTRAINT "CommentLike_topicId_fkey" FOREIGN KEY ("topicId") REFERENCES "Topic"("id") ON DELETE CASCADE ON UPDATE CASCADE;
