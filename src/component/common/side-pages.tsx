...
export default function SideLinksPages() {
    return (
        <>
            <div className="my-4">
            ...
            <div className="flex justify-start mb-4">
                <Link
                    ...
                    className="p-2 inline-block flex items-center justify-center bg-transparent hover:bg-blue-300 rounded-md flex w-full"
                >
                    <FaXTwitter className="w-6 h-6" />
                </Link>
                <Link
                    href="https://www.instagram.com/"
                    className="p-2 inline-block bg-transparent flex items-center justify-center hover:bg-blue-300 rounded-md  flex w-full"
                >
